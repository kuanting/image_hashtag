...
def command():
    ...
    parser.add_argument("-epos", "--epochs", type=int, dest="epos", help="Numbers of epochs, Default is 1000", default=100)
...
if __name__ == "__main__":
    ...
    # data, corpus, _, word2idx, idx2word = read_tags(folder_dir, filename, args)
    ...
    for epoch in range(args.epos):
        ...
        for i,(x,y) in enumerate(training_data, 1):
            ...
            # loss = F.nll_loss(y_pred.view(-1,len(corpus)), y)
